...
const Footer = (props) => {
  return (
    <div className={`${props.bgColor} mobile:hidden h-[244px] flex flex-col justify-center`}>
      <div className={`${props.txColor} flex flex-row items-center justify-around`}>
        <h1 className='px-5 self-center mb-6 text-[2rem] leading-[2rem] font-header w-[200px] h-[58px] font-extrabold'>
          MODERN ART GALLERY
        </h1>
        <p className={`px-5  h-[84px] w-[430px] font-outfit`}>
        ...
        <div className='flex flex-row self-start gap-4 hover:children:bg-goldBrown'>
